...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-JunoFirst_MiSTer.git"
CORE_NAME=(JunoFirst)
...
UPSTREAM_CORE_NAME=(JunoFirst)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-JunoFirst.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-JunoFirst.rbf)
